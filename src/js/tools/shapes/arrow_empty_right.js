...
class Arrow_Empty_Right_class extends Base_tools_class {

    constructor(ctx) {
        super();
        this.Base_layers = new Base_layers_class();
        this.ctx = ctx;
        this.name = 'arrow_empty_right';
        this.layer = {};
        ...
        this.coords = [
            ...
            [75,75],
            [24.99999999999999, 75.30127018922192],
            [25, 50],
...
export default Arrow_Empty_Right_class;
